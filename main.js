...
console.log(color('> WA NUMBER: +994404069683 ','silver'))
console.log(color('  Xeon Bot Inc. 2022','mediumseagreen'))
    ...
    console.log(color('<>','red'), color('But? Error? Suggestion? Visit Here:', 'aqua'), color('https://wa.me/994404069683'))
    ...
    DogeXeonOP.sendMessage(`994404069683@s.whatsapp.net`, `Thanks bro, your bot is working on my whatsapp number ez😂`, MessageType.extendedText)
